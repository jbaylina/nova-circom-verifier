...
# This file was *autogenerated* from the file testvector_x5_t2_gk.sage
from sage.all_cmdline import *   # import sage library

_sage_const_508 = Integer(508); _sage_const_2 = Integer(2); _sage_const_8 = Integer(8); _sage_const_56 = Integer(56); _sage_const_0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47 = Integer(0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47); _sage_const_0 = Integer(0); _sage_const_16 = Integer(16); _sage_const_4 = Integer(4); _sage_const_1 = Integer(1); _sage_const_5 = Integer(5)# M = 128
N = _sage_const_508 
t = _sage_const_2 
n = int(N / t)
R_F = _sage_const_8 
R_P = _sage_const_56 
prime = _sage_const_0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47 
F = GF(prime)
...
MDS_matrix = [
   [
    "0x2a577ab0eb40d309ecdaa1899bc2691325616dfbcbc161dc0d001df7b71abdae",
    "0x0344a9797ac9b175d953b288c721808be211de10c0c4e1472f00ef5863626258"
   ],
   [
    "0x0809b05cd41ccfaebce4ad123edb3f2333c9799fbedcfcc484b74815cf7fe70c",
    "0x208347b72dacabec09e3fa5c1a11fa22646b1966aa1fbf6dc5d12b7970796575"
   ]
  ]
